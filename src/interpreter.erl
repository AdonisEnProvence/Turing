...
start(MachineConfig, Input) ->
    io:format("Interpreter starting..."),
    Tape = Input,
    IndexOnTape = 0,
    io:format("Interpreter closing...").
...
read_and_execute_current_tape_index(Tape, IndexOntape, MachineConfig) ->
    io:format("Read and execute index tape value ..."),
    [TapeCurrentValue | Rest ] = Tape[],
    .
